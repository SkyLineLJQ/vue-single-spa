    ...
    <a-layout id="components-layout-demo-custom-trigger">
        ...
        <a-layout>
            <a-layout-header style="background: #fff; padding: 0">
                ...
                />
                <span>single-spa计数器：{{ ButtonCount}}</span>
                <a-button type="primary" @click="addCount">Primary</a-button>
            </a-layout-header>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addCount() {
                let self = this
                self.$store.commit("addCountEvent", false);
            }
        }
    };
</script>
